...
import { Select, Text, Group, Switch } from "@mantine/core";
    ...
    () => [
      ...
      },
      {
        ...
        Cell: ({ row }) => {
          ...
          return projectName ? (
            ...
            <Text c="dimmed">Без проекта</Text>
          );
        },
      },
      {
      ...
      },
      {
        ...
        Cell: ({ cell }) => {
          ...
          return endValue ? (
            dayjs(endValue).format("HH:mm")
          ) : (
            <Text c="dimmed">В процессе...</Text>
          );
        },
      },
      {
            ...
            {selectedWeekData && (
              <>
                <Text size="sm" c="dimmed">
                  Всего времени:{" "}
                  <strong>
                    {formatDuration(selectedWeekData.totalMinutes)}
                  </strong>
                </Text>
                <Text size="sm" c="dimmed">
                  Всего часов:{" "}
                  <strong>
                    {selectedWeekData.totalHours?.toFixed(2) || "0.00"}
                  </strong>
                </Text>
              </>
            )}
